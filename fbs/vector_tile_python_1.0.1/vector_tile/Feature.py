...
def FeatureAddNameZh(builder, nameZh):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(nameZh), 0)

def AddNameZh(builder, nameZh):
    FeatureAddNameZh(builder, nameZh)
...
def FeatureAddNameDetail(builder, nameDetail):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(nameDetail), 0)

def AddNameDetail(builder, nameDetail):
    FeatureAddNameDetail(builder, nameDetail)

def FeatureAddPmapKind(builder, pmapKind):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(pmapKind), 0)

def AddPmapKind(builder, pmapKind):
    FeatureAddPmapKind(builder, pmapKind)

def FeatureAddPmapMinZoom(builder, pmapMinZoom):
    builder.PrependUint8Slot(6, pmapMinZoom, 0)
