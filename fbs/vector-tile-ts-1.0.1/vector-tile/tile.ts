...
static addGrid(builder:flatbuffers.Builder, grid:number) {
  builder.addFieldInt8(1, grid, 4);
}
...
static createTile(builder:flatbuffers.Builder, layersOffset:flatbuffers.Offset, grid:number):flatbuffers.Offset {
  Tile.startTile(builder);
  Tile.addLayers(builder, layersOffset);
  Tile.addGrid(builder, grid);
