...
export class Feature {
    ...
    static createFeature(builder, id, coverage, nameZhOffset, nameEnOffset, nameDetailOffset, pmapKindOffset, pmapMinZoom, type, geometryOffset) {
